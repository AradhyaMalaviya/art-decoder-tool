...
export const exercises: Exercise[] = [
  ...
  // Shoulders Exercises - INTERMEDIATE
  {
    id: '13',
    name: 'Shoulder Press',
    muscleGroup: 'Shoulders',
